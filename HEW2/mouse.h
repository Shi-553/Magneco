...
enum Mouse_Axis
{
    MOUSE_AXIS_NONE = MOUSE_BUTTONS_MAX,
    MOUSE_X,
    MOUSE_Y,
    MOUSE_WHEEL,
    MOUSE_AXIS_MAX
...
bool Mouse_IsKeyDown(Mouse_Buttons button);


bool Mouse_IsKeyUp(Mouse_Buttons button);

int Mouse_GetAxis(Mouse_Axis axis);
